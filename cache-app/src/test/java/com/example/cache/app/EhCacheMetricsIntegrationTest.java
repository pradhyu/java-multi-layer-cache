...
class EhCacheMetricsIntegrationTest {
        ...
        void testCacheOperationsGenerateMetrics() throws Exception {
                ...
                List<String> result1 = multiLayerCache.get("user:1").orElse(null);
                ...
                List<String> result2 = multiLayerCache.get("user:1").orElse(null);
                ...
                List<String> result3 = multiLayerCache.get("user:2").orElse(null);
                ...
                List<String> result4 = multiLayerCache.get("product:1").orElse(null);
